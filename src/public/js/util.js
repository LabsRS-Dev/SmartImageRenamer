...
(function(){
    ...
    // OS判断区域
    $.isWin = navigator.platform.indexOf('Win',0) > -1;
    $.isMac = navigator.platform.indexOf('Mac',0) > -1;
    $.isUnix = navigator.platform.indexOf('X11',0) > -1;
    $.isLinux = navigator.platform.indexOf('Linux',0) > -1;
